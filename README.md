...
[![Build Status](https://travis-ci.org/powermobileteam/peatio.svg?branch=master)](https://travis-ci.org/powermobileteam/peatio)
...
and extend it using other microservices such as [Barong](https://www.github.com/powermobileteam/barong).
...
* [KYC Verification](http://en.wikipedia.org/wiki/Know_your_customer) provided by [Barong](https://www.github.com/powermobileteam/barong)
...
We suggest you to start using Peatio by installing [Workbench](https://github.com/powermobileteam/workbench). [Workbench](https://github.com/powermobileteam/workbench) which is based on [Docker containers](https://www.docker.com/what-docker) is a convenient and straightforward way to start Peatio development environment.
...
1. Recursive clone : `git clone --recursive https://github.com/powermobileteam/workbench.git`
...
##### [Barong](https://github.com/powermobileteam/barong)

Barong is an essential part of powermobileteam Peatio. It is a KYC OAuth 2.0 provider. Barong replace the KYC, 2FA, Phone verification from legacy Peatio.
...
If you spot a bug, then please raise an issue in our main GitHub project (powermobileteam/peatio); likewise, if you have developed a cool new feature or improvement in your powermobileteam Peatio fork, then send us a pull request!
If you want to brainstorm a potential new feature, then the powermobileteam Discourse Forum (see above) is probably a better place to start.
...
Contact us by email: [info@powermobile.org]
...
**[This illustration copyright for PowerMobile Team]**
